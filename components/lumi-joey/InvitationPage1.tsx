    ...
    <div className="relative w-full h-full bg-gradient-to-br from-[#e7d4bd] via-[#e7d4bd] to-amber-50 overflow-hidden shadow-xl rounded-lg">
            ...
            <div className="relative z-10 h-full flex flex-col items-right justify-right pl-3 sm:pl-12 pr-3 sm:pr-20 py-16" style={{ fontFamily: 'Playlist Script, cursive' }}>
                ...
                <div className="mb-2 leading-none space-y-1">
                    <h3 className="text-2xl sm:text-4xl text-amber-800 sm:pl-[30%] text-center sm:text-left" style={{ fontFamily: 'Playlist Script, cursive', fontStyle: 'italic' }}>
                        Oluwapelumi Sarah
                    </h3>
                    <div className="text-4xl sm:text-7xl font-bold text-amber-800 sm:pl-[65%] text-center sm:text-left" style={{ fontFamily: 'Brittany, cursive', fontStyle: 'italic', lineHeight: '1' }}>
                        &
                    </div>
                    <h3 className="text-2xl sm:text-4xl text-amber-800 text-center sm:text-right" style={{ fontFamily: 'Playlist Script, cursive', fontStyle: 'italic' }}>
                        Joseph Adegboyega
                    </h3>
                </div>
